...
const Sponsor = (name, logo) => {
    return (
        <div className="relative z-10 min-w-[18vw] flex flex-col max-w-[60vw] items-center overflow-visible justify-center aspect-square bg-gradient-to-b from-[#E7BB67] to-[#F4E0B9] rounded-lg">
