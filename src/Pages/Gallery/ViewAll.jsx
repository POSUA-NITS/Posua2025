...
const ViewAll = ({ onClose }) => {
  ...
  <button
    className={`${styles.year_button} ${year1 ? styles.active : ''}`}
    onClick={() => {
      setYear1(true);
      setYear2(false);
      setYear3(false);
  ...
  <button
    className={`${styles.year_button} ${year2 ? styles.active : ''}`}
    onClick={() => {
      setYear1(false);
      setYear2(true);
      setYear3(false);
  ...
  <button
    className={`${styles.year_button} ${year3 ? styles.active : ''}`}
    onClick={() => {
      setYear1(false);
      setYear2(false);
      setYear3(true);
  ...
  >
    <span>2020</span>
            ...
            <button className={styles.back_button} onClick={onClose}><span>Back</span></button>
          </div>
        </div>
       
       { year1 &&  <div className={styles.section2}>
          {images1.map((image, index) => (
            <div key={image.id} className={styles.card} onClick={() => setSelectedImage(index)}>
              <img src={image.url} alt={`Gallery ${image.id}`} className={styles.image} />
            </div>
          ))}
        </div>
          }

    { year2 &&  <div className={styles.section2}>
    ...
    { year3 &&  <div className={styles.section2}>
