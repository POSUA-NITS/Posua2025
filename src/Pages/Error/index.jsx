...
const Error = () => {
    ...
    return (
        <section className='flex flex-col font-gotham items-center justify-center h-screen w-full bg-gradient-to-b from-[#FFE8A9] via-[#FEFEFE] to-[#FEFEFE]'>
            <div className='flex w-1/2 items-center justify-center mt-8'>
                <h1 className='text-9xl md:text-[20rem] text-red-500'>4</h1>
                <img src='https://res.cloudinary.com/dmezugavw/image/upload/v1742788146/japi_mpifgg.webp' alt='404' className='w-[25vw] md:w-1/3' />
                <h1 className='text-9xl md:text-[20rem] text-red-500'>4</h1>
            </div>
